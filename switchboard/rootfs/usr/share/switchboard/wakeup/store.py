...
class _Lock:
    ...
    def __enter__(self):
        ...
        try:
            os.chmod(self.path, 0o664)  # intentional: root services AND the asterisk-user AGIs share this file; group access is required
        except OSError:
            pass
