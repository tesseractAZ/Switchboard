"""Home PBX — Ingress management UI.
...
AMI_HOST = "127.0.0.1"
AMI_PORT = 5038
AMI_USER = os.environ.get("AMI_USER", "hapbx")
AMI_SECRET = os.environ.get("AMI_SECRET", "")

app = FastAPI(title="Home PBX", docs_url=None, redoc_url=None)
...
def api_status() -> JSONResponse:
    ...
    # Configured rooms that have not registered yet.
